...
class VariableExpressionTest {
    ...
    void testEvalBound() throws UnboundVariableException {
        ...
        MapVarTable arr = new MapVarTable();
        arr.set("x", 5);
        assertEquals(5, expr.eval(arr));
        arr.set("x", Math.PI);
        assertEquals(3.141592653589793, expr.eval(arr));
...
class OperationExpressionTest {
    ...
    void testEvalAdd() throws UnboundVariableException {
        // TODO: Uncomment this test, adjusting constructor invocations as necessary
        Expression expr = new Operation(Operator.ADD, new Constant(1.5),
                new Constant(2));
    ...
    void testEvalAddUnbound() {
        Expression expr = new Operation(Operator.ADD, new Variable("x"),
                new Variable("y"));
        MapVarTable arr = new MapVarTable();
        assertThrows(UnboundVariableException.class, () -> expr.eval(arr));
    }
    ...
    void testOpCountLeaves() {
        Expression expr = new Operation(Operator.ADD, new Constant(5),
                new Constant(5));
    ...
    void testInfixLeaves() {
        Expression expr = new Operation(Operator.ADD,
                new Constant(2.0),
                new Constant(2.0));
        assertEquals("(2.0 + 2.0)", expr.infixString());

        expr = new Operation(Operator.SUBTRACT,
                new Constant(2.0),
                new Constant(-3.0));;
        assertEquals("(2.0 - -3.0)", expr.infixString());
    }
    ...
    void testPostfixLeaves() {
        Expression expr = new Operation(Operator.ADD,
                new Constant(3.0),
                new Constant(2.0));
        assertEquals("3.0 2.0 +", expr.postfixString());
...
//      TODO (at least two cases; you may crib from testInfixRecursive above)
    ...
    void testEqualsTrue() {
        // TODO: Uncomment this test, adjusting constructor invocations as necessary
        Expression expr1 = new Operation(Operator.ADD, new Constant(1.5),
                new Variable("x"));
        Expression expr2 = new Operation(Operator.ADD, new Constant(1.5),
                new Variable("x"));
        assertTrue(expr1.equals(expr2));
    }
    ...
    void testEqualsFalse() {
        Expression expr1 = new Operation(Operator.ADD, new Constant(1.5),
                new Variable("x"));
        Expression expr2 = new Operation(Operator.MULTIPLY, new Constant(1.5),
                new Variable("x"));
        assertFalse(expr1.equals(expr2));
    }
    ...
    void testOptimizeAdd() {
        Expression expr = new Operation(Operator.ADD, new Constant(5),
                new Constant(7));
        Constant cons = new Constant(12);
        assertEquals(cons,expr.optimize(MapVarTable.empty()));
    }
}
...
class ApplicationExpressionTest {
    ...
    void testEvalSqrt() throws UnboundVariableException {
        ...
        Expression app = new Application(UnaryFunction.SQRT, expr);
        MapVarTable arr = new MapVarTable();
        assertEquals(2.0, app.eval(arr));
    }
    ...
    void testEvalAbsUnbound() {
        ...
        Expression app = new Application(UnaryFunction.SQRT, expr);
        MapVarTable arr = new MapVarTable();
        assertThrows(UnboundVariableException.class, () -> app.eval(arr));
    }
    ...
    void testOpCountRecursive() {
        // TODO: Uncomment this test, adjusting constructor invocations as necessary
        Expression expr = new Application(UnaryFunction.SQRT,
                new Operation(Operator.MULTIPLY, new Constant(1.5),
                        new Variable("x")));
        assertEquals(2, expr.opCount());
    }
    ...
    void testInfixLeaves() {
        Expression expr = new Application(UnaryFunction.ABS,
                new Constant(1.5));
        assertEquals("abs(1.5)", expr.infixString());
    }
    ...
    void testPostfixLeaves() {
        Expression expr = new Application(UnaryFunction.ABS,
                new Constant(1.5));
        assertEquals("1.5 abs()", expr.postfixString());
    }
    ...
    void testEqualsFalseArg() {
        Expression expr1 = new Application(UnaryFunction.SQRT, new Constant(5.0));
        Expression expr2 = new Application(UnaryFunction.SQRT, new Constant(4.0));
        assertFalse(expr1.equals(expr2));
    }
    ...
    void testOptimizeConstant() {
        Expression expr = new Application(UnaryFunction.SQRT, new Constant(9));
